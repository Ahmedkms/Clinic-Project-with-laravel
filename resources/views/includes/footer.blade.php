    ...
    <div class="row gap-2">
        ...
        <div class="col-sm order-sm-2">
            ...
            <div class="links d-flex gap-2 flex-wrap">
                <a href="{{ route('index_page') }}" class="link text-white">Home</a>
                <a href="{{ route('majors') }}" class="link text-white">Majors</a>
                <a href="{{ route('doctor_index') }}" class="link text-white">Doctors</a>
                <a href="{{ route('login') }}" class="link text-white">Login</a>
                <a href="{{ route('register') }}" class="link text-white">Register</a>
                <a href="{{ route('contactView') }}" class="link text-white">Contact</a>
            </div>
        </div>
    </div>
</footer>